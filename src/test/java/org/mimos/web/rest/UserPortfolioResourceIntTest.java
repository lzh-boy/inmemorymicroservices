...
import org.mimos.web.rest.errors.ExceptionTranslator;
...
import static org.mimos.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = InmemorymicroservicesApp.class)
public class UserPortfolioResourceIntTest {
    ...
    public void setup() {
        ...
        final UserPortfolioResource userPortfolioResource = new UserPortfolioResource(userPortfolioRepository, userPortfolioSearchRepository);
    ...
    public void createUserPortfolio() throws Exception {
        ...
        assertThat(testUserPortfolio.getUserid()).isEqualTo(DEFAULT_USERID);
    ...
    public void updateUserPortfolio() throws Exception {
        ...
        UserPortfolio testUserPortfolio = userPortfolioList.get(userPortfolioList.size() - 1);
        assertThat(testUserPortfolio.getUserid()).isEqualTo(UPDATED_USERID);
